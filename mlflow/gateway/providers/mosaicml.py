...
class MosaicMLProvider(BaseProvider):
    ...
    async def _request(self, model: str, payload: typing.Dict[str, Any]) -> typing.Dict[str, Any]:
    ...
    @staticmethod
    def _parse_chat_messages_to_prompt(messages: typing.List[chat.RequestMessage]) -> str:
        """
