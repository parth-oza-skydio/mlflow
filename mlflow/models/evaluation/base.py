...
def _generate_eval_metric_class(eval_fn, require_strict_signature=False):
    ...
    if require_strict_signature:
        ...
        def genai_call_method(
            self,
            *,
            predictions: Union[pd.Series, str, typing.List[str]],
            inputs: Union[pd.Series, str, typing.List[str]],
            metrics: Optional[typing.Dict[str, MetricValue]] = None,
            **kwargs,
        ) -> MetricValue:
        ...
        genai_call_method.__signature__ = Signature(
            parameters=[
                ...
                Parameter(
                    ...
                    annotation=Union[pd.Series, str, typing.List[str]],
                ),
                Parameter(
                    "inputs",
                    Parameter.KEYWORD_ONLY,
                ...
                Parameter(
                    "metrics",
                    Parameter.KEYWORD_ONLY,
                    annotation=Optional[typing.Dict[str, MetricValue]],
                    default=None,
                ),
                *[
                    Parameter(
                        name, Parameter.KEYWORD_ONLY, annotation=Union[pd.Series, str, typing.List[str]]
                    )
...
class EvaluationResult:
    ...
    @property
    def artifacts(self) -> typing.Dict[str, "mlflow.models.EvaluationArtifact"]:
        """
    ...
    @experimental
    @property
    def tables(self) -> typing.Dict[str, "pd.DataFrame"]:
        """
...
def _resolve_default_evaluator(model_type, default_config) -> typing.List[EvaluatorBundle]:
    """
...
def resolve_evaluators_and_configs(
    evaluators: Union[str, typing.List[str], None],
    evaluator_config: Union[typing.Dict[str, Any], None],
    model_type: Optional[str] = None,
) -> typing.List[EvaluatorBundle]:
    """
...
def _get_model_from_deployment_endpoint_uri(
    endpoint_uri: str, params: Optional[typing.Dict[str, Any]] = None
):
    from mlflow.metrics.genai.model_utils import _parse_model_uri
...
def evaluate(  # noqa: D417
    ...
    *,
    ...
    evaluators: typing.List[EvaluatorBundle] = resolve_evaluators_and_configs(
