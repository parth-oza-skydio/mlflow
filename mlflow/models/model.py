...
class ModelInfo:
    ...
    def __init__(
        self,
        artifact_path: str,
        flavors: typing.Dict[str, Any],
        model_uri: str,
        model_uuid: str,
        run_id: str,
        saved_input_example_info: Optional[typing.Dict[str, Any]],
        signature,  # Optional[ModelSignature]
        utc_time_created: str,
        mlflow_version: str,
        signature_dict: Optional[typing.Dict[str, Any]] = None,
        metadata: Optional[typing.Dict[str, Any]] = None,
        registered_model_version: Optional[int] = None,
        env_vars: Optional[typing.List[str]] = None,
        prompts: Optional[typing.List[str]] = None,
    ):
    ...
    @property
    def flavors(self) -> typing.Dict[str, Any]:
        """
    ...
    @property
    def saved_input_example_info(self) -> Optional[typing.Dict[str, Any]]:
        """
    ...
    @property
    def signature_dict(self) -> Optional[typing.Dict[str, Any]]:
        """
    ...
    @property
    def env_vars(self) -> Optional[typing.List[str]]:
        """
    ...
    @env_vars.setter
    def env_vars(self, value: Optional[typing.List[str]]) -> None:
    ...
    @experimental
    @property
    def metadata(self) -> Optional[typing.Dict[str, Any]]:
        """
    ...
    @property
    def prompts(self) -> Optional[typing.List[str]]:
...
class Model:
    ...
    def __init__(
        ...
        saved_input_example_info: Optional[typing.Dict[str, Any]] = None,
    ...
    @experimental
    @metadata.setter
    def metadata(self, value: Optional[typing.Dict[str, Any]]) -> None:
    ...
    def saved_input_example_info(self, value: typing.Dict[str, Any]) -> None:
    ...
    @experimental
    @property
    def resources(self) -> typing.Dict[str, typing.Dict[ResourceType, typing.List[dict]]]:
        """
    ...
    @experimental
    @resources.setter
    def resources(self, value: Optional[Union[str, typing.List[Resource]]]) -> None:
    ...
    @experimental
    @property
    def auth_policy(self) -> typing.Dict[str, dict]:
        """
    ...
    def get_tags_dict(self) -> typing.Dict[str, Any]:
        result = self.to_dict()
...
def update_model_requirements(
    ...
    requirement_list: typing.List[str],
) -> None:
    """
